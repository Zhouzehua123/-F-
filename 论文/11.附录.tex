...
本论文末尾对人工智能工具的实际使用范围作统一说明。腾讯 WorkBuddy 接入 DeepSeek-V4-Flash（2026-07-31 公开测试）用于图表展示参考，GLM-5.1 用于排版检查；OpenAI Codex（GPT-5.6，2026-04-21）用于程序整理、数据整理和结果复核。工具信息见文献 \cite{ai_workbuddy,ai_glm,ai_codex56}。
