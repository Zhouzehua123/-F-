...
本论文末尾对人工智能工具的实际使用范围作统一说明。腾讯 WorkBuddy 接入 DeepSeek-V4-Flash（2026-07-31 公开测试）用于图表展示参考，GLM-5.1 用于排版检查；OpenAI Codex（GPT-5.4、GPT-6 系列）用于程序整理、数据整理和结果复核。各问局部说明只覆盖对应环节，所有采用内容均经队伍核验并以保存的输入、输出和源程序为准。工具信息见文献 \cite{ai_workbuddy,ai_glm,ai_codex54,ai_codex6}。
