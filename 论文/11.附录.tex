...
本论文末尾对人工智能工具的实际使用范围作统一说明。腾讯 WorkBuddy 接入 DeepSeek-V4-Flash 用于文段整理与图表制作，GLM-5.1 用于排版检查；Codex 用于文段改述、逐句表达检查、数据整理、结果核对以及本附录所列程序的整理与核对。各问局部说明只覆盖对应环节，不能据此推断工具替代了模型选择、假设设定、程序运行或结论责任；参赛队对提交内容进行核验并承担责任，工具信息见文献 \cite{ai_workbuddy,ai_glm,ai_codex54,ai_codex6}。
...
图\ref{fig:p1_quality_full} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_conf} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_structure} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_r2} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_nonlinear} & 问题一/\allowbreak{}重绘图表.py & 非线性代理对照逐域表及预测明细 \\
图\ref{fig:p1_heatmap} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_scatter} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_quality} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
图\ref{fig:p1_extrap} & 问题一/\allowbreak{}重绘图表.py & 问题一结果 CSV 与附件 A4--A15 \\
...
图\ref{fig:p4_map} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_scale} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_decomp} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_frontier} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_distribution} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_task} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
图\ref{fig:p4_c4} & 问题四/\allowbreak{}重绘图表.py & 问题四结果 CSV 与附件 C1、C6 \\
\end{longtable}
