...
本论文末尾对人工智能工具的实际使用范围作统一说明。腾讯 WorkBuddy 接入 DeepSeek-V4-Flash（2026-07-31 公开测试）用于文段相关辅助；OpenAI Codex（GPT-5.6-Luna，2026-04-21）用于图表展示、排版检查、程序整理、数据整理和结果复核。工具信息见文献 \cite{ai_workbuddy,ai_codex56luna}。
